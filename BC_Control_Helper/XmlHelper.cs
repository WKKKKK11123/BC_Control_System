...
namespace BC_Control_Helper
{
    internal class XmlHelper
    {
        ...
        public bool boolDeleteNodes(string XmlFile, string fatherNode)
...

        {
...

            {
...

                {
                    ...
                    foreach (XmlAttribute attributein in xmlNode.Attributes)

                    {

                        if (attributein.Name.ToLower() == xmlAttributeName.ToLower())

                        {

                            //节点中存在此属性

                            xmlAttribute = attributein;
