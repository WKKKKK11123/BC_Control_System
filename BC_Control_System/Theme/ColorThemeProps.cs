...
namespace BC_Control_System.Theme
{
    public class ColorThemeProps
    {
        ...
        public static readonly DependencyProperty BackgroundProperty =
            DependencyProperty.RegisterAttached("Background", typeof(Brush), typeof(ColorThemeProps), new PropertyMetadata(null,OnBackgroundPropertyChanged));
        ...
        public static readonly DependencyProperty ForegroundProperty =
            DependencyProperty.RegisterAttached("Foreground", typeof(Brush), typeof(ColorThemeProps), new PropertyMetadata(null,OnForegroundPropertyChanged));
