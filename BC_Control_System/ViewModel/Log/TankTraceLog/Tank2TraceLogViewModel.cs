...
{
    class Tank2TraceLogViewModel : InsertTimeLogViewModelBase<TK2DataLogClass, TK2LogDataService>, INavigationAware
    {
        //private List<TK2DataLogClass> insertTimeCollections;
        //public override List<TK2DataLogClass> InsertTimeCollections
        //{
        //    get => insertTimeCollections;
        //    set => SetProperty(ref insertTimeCollections, value);
        //}
        public Tank2TraceLogViewModel(
            ILogCommandService commandService,
            TK2LogDataService dataBaseService,
