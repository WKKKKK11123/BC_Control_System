...
{
    public class Tank4TraceLogViewModel : InsertTimeLogViewModelBase<TK4DataLogClass, TK4LogDataService>, INavigationAware
    {
        //private List<TK4DataLogClass> insertTimeCollections;
        //public override List<TK4DataLogClass> InsertTimeCollections
        //{
        //    get => insertTimeCollections;
        //    set => SetProperty(ref insertTimeCollections, value);
        //}
        public Tank4TraceLogViewModel(
            ILogCommandService commandService,
            TK4LogDataService dataBaseService,
