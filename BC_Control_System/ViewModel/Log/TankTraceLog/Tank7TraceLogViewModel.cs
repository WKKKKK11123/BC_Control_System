...
{
    class Tank7TraceLogViewModel : InsertTimeLogViewModelBase<TK7DataLogClass, TK7LogDataService>, INavigationAware
    {
        //private List<TK7DataLogClass> insertTimeCollections;
        //public override List<TK7DataLogClass> InsertTimeCollections
        //{
        //    get => insertTimeCollections;
        //    set => SetProperty(ref insertTimeCollections, value);
        //}
        public Tank7TraceLogViewModel(
            ILogCommandService commandService,
            TK7LogDataService dataBaseService,
