...
namespace BC_Control_System.ViewModel
{
	...
	public class MainWindowModel : BindableBase, IConfigureService
	{
		...
		public AuthService AuthManager { get; set; }
		public string PLCState { get; set; } = "";
		public string PLC2State { get; set; } = "";
		public string PLC3State { get; set; } = "";
		public string PLC4State { get; set; } = "";
		public string PLC5State { get; set; } = "";
		public string PLC6State { get; set; } = "";
		...
		public ObservableCollection<StationCollection> ProcessTankCollections { get; set; }
		public ObservableCollection<StationCollection> BufferTankCollections { get; set; }
		public ObservableCollection<StationCollection> MachineCollections { get; set; }
		#region 视图命令
		...
		private void _processControl_WTSDownRecipe(string obj)
		{
		...
		private void _processControl_WTRGetCompleteEvent(PusherStationState obj)
		{
			...
			finally
			{
				...
				CommonStaticMethods.WritePusherToPLC(obj);
